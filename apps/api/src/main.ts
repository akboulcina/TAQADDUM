...
class AppModule {}
async function bootstrap() { const app = await NestFactory.create(AppModule, new FastifyAdapter(), { bufferLogs: true }); await app.listen(Number(process.env.PORT ?? 3000), '0.0.0.0'); }
void bootstrap();
