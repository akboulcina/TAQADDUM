...
export const ButtonArRtl: StoryObj = {
  render: () => (
    <div dir="rtl">
      <Button>حفظ</Button>
    </div>
...
export const TextArRtl: StoryObj = {
  render: () => (
    <div dir="rtl">
      <Text>مشروع</Text>
    </div>
...
export const StatusBadgeArRtl: StoryObj = {
  render: () => (
    <div dir="rtl">
...
export const AlertBannerArRtl: StoryObj = {
  render: () => (
    <div dir="rtl">
      <AlertBanner>واجهة API متصلة</AlertBanner>
    </div>
  ),
};
